...
sudo docker build -t ghcr.io/andiyudi/karsajobs-ui:latest .

#Perintah untuk login ke GitHub Package.
echo "Logging in to GitHub Package..."
echo $PAT | docker login ghcr.io -u andiyudi --password-stdin

#Perintah untuk push image ke GitHub Package.
echo "Pushing Docker image to GitHub Package..."
docker push ghcr.io/andiyudi/karsajobs-ui:latest