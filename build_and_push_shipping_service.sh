#Perintah untuk build Docker image dari berkas Dockerfile yang disediakan dengan nama shipping-service
echo "Building Docker image for GitHub Package..."
sudo docker build -t ghcr.io/andiyudi/shipping-service:latest .
...
docker push ghcr.io/andiyudi/shipping-service:latest