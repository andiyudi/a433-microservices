...
sudo docker build -t ghcr.io/usernamegithub/karsajobs:latest

#Perintah untuk login ke GitHub Package.
echo "Logging in to GitHub Package..."
echo $PAT | docker login ghcr.io -u usernamegithub --password-stdin

#Perintah untuk push image ke GitHub Package.
echo "Pushing Docker image to GitHub Package..."
sudo docker push ghcr.io/usernamegithub/karsajobs:latest